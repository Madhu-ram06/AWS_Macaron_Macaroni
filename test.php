<!DOCTYPE html>
    ...
    <div class = "favourite">
        <?php
        include 'db.inc.php';
        $sql = "SELECT i.recipe_id, i.title, i.ingredients, i.instructions from cuisines c, italian i where c.recipe_id=i.recipe_id and c.cuisine='italian' union select r.recipe_id, r.title, r.ingredients, r.instructions from cuisines c, chinese r where c.recipe_id=r.recipe_id and c.cuisine='chinese';";
